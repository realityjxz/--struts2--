        ...
        <div role="tabpanel" class="tab-pane" id="user">
            ...
            <div class="data-div">
                <table>
                    ...
                    <div class="row">
                        <div class="col-xs-1 "> 课程号</div>
                        <div class="col-xs-2"> 课程名</div>
                        <div class="col-xs-1 "> 教工号</div>
                        <div class="col-xs-1 "> 教师姓名</div>
                        <div class="col-xs-1 "> 班级</div>
                        <div class="col-xs-2 ">上课地点</div>
                    ...
                    <s:iterator value="tcousByObj" var="tcou">
                        <div class="row">
                            <div class="col-xs-1"><s:property value="#tcou.Cno"/></div>
                            <div class="col-xs-2"><s:property value="#tcou.Cname"/></div>
                            <div class="col-xs-1"><s:property value="#tcou.Tno"/></div>
                            <div class="col-xs-1"><s:property value="#tcou.Tname"/></div>
                            <div class="col-xs-1"><s:property value="#tcou.Sclass"/></div>
                            <div class="col-xs-2"><s:property value="#tcou.Site"/></div>
                            <div class="col-xs-1"><s:url var="editUrl" action="tcou_edit">
                                <s:param name="tcou.cno" value="#tcou.Cno"/>
                            </s:url>
                                <a href="${editUrl}">edit</a></div>
                            <div class="col-xs-1">
                                <s:url var="delUrl" action="tcou_del">
                                    <s:param name="tcou.cno" value="#tcou.Cno"/>
                                </s:url>
                                <a href="${delUrl}" onClick="return readyDel(<s:property
                                        value='#tcou.cno'/>);">del</a></div>
                        </div>
                    </s:iterator>
                    </tbody>
                </table>
