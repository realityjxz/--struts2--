            ...
            <div class="data-div">
                <table>
                    ...
                    <s:iterator value="scoresByObj" var="score">
                        <div class="row">
                            <div class="col-xs-2"><s:property value="#score.Sno"/></div>
                            <div class="col-xs-2"><s:property value="#score.Sname"/></div>
                            <div class="col-xs-1"><s:property value="#score.Cno"/></div>
                            <div class="col-xs-2"><s:property value="#score.Cname"/></div>
                            <div class="col-xs-2"><s:property value="#score.Sclass"/></div>
                            <s:if test="#score.Score>=60">
                            <div class="col-xs-1"><s:property value="#score.Score"/></div>
                            </s:if>
                            <s:else>
                                <div class="col-xs-1" style="background-color: #2c3e50"><s:property value="#score.Score"/></div>
                            </s:else>

                            <div class="col-xs-1">
                                <s:url var="editUrl" action="score_edit">
