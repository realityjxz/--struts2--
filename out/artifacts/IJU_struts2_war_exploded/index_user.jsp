...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div class="meun-item meun-item-active"><a href="user_list.action"><img src="images/icon_source.png">管理员信息</a> </div>
    ...
    <script>
        ...
        slip('.slider-minmax1', "分钟", "5", 30);
        slip('.slider-minmax2', "分钟", "6", 15);
        slip('.slider-minmax3', "分钟", "10", 60);
        slip('.slider-minmax4', "次", "2", 10);
        slip('.slider-minmax5', "天", "3", 7);
        slip('.slider-minmax6', "天", "8", 10);
    </script>
    </body>
