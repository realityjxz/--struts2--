...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div class="meun-item meun-item-active"><img src="images/icon_source.png">管理员信息</div>
        <div class="meun-item"><img src="images/icon_chara_grey.png">学生管理</div>
        <div class="meun-item"><img src="images/icon_user_grey.png">成绩管理</div>
        <div class="meun-item"><img src="images/icon_change_grey.png">修改</div>
        <div class="meun-title">教师-班级</div>
        <div class="meun-item"><img src="images/icon_house_grey.png">班级管理</div>
        <div class="meun-item"><img src="images/icon_rule_grey.png">课程管理</div>
        <div class="meun-item"><img src="images/icon_card_grey.png">教师信息</div>
        <div class="meun-item"><img src="images/icon_char_grey.png">图表展示</div>
    </div>
    <%--右侧菜单栏--%>
    <div id="rightContent">
